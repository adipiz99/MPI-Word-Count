...
wordCount: linkedList.o linkedFileList.o fileManagement.o wordManagement.o main.o
	mpicc $(mkfile_dir)src/linkedList.o $(mkfile_dir)src/linkedFileList.o $(mkfile_dir)src/main.o $(mkfile_dir)src/fileManagement.o $(mkfile_dir)src/wordManagement.o -o $(mkfile_dir)src/wordCount.out
